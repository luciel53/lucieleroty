...
const ServiceCard = ({ title, paragraph, ul, paragraph2, img, link }) => {
  ...
  return (
    <section data-aos="fade-up" data-aos-transform="translate" className="mx-1 md:mx-4 lg:mx-20 lg:mt-10 lg:mb-10 animate-fade animate-duration-1000 animate-delay-[400ms] animate-ease-in">
      <div className="flex flex-wrap-reverse lg:flex-nowrap md:flex-row h-auto z-10 relative justify-center opacity-90 bg-verylightgray border-2 border-lightgreen rounded-lg">
        ...
        <div className="flex flex-col lg:w-1/2">
          <h3 className=" font-specialelite p-2 mt-2 text-center mx-auto">{title}</h3>
          ...
          <Link href={link}>
            <button className="relative overflow-hidden bg-darkgreen w-20 md:w-40 lg:w-60 md:h-8 mb-2 lg:mb-4 mx-10 md:mx-28 lg:mx-56 rounded-lg shadow-lg text-verylightgray text-[0.6rem] md:text-lg border-2 border-darkgreen hover:border-2  hover:border-darkgreen group">
